<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Opportunity: <?= esc($opportunity['project_name']) ?></h1>
...
<div class="card">
    <div class="card-body">
        <form action="<?= base_url('sales/opportunities/update/' . $opportunity['id']) ?>" method="post">
            <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="project_name" name="project_name"
                            value="<?= old('project_name', $opportunity['project_name']) ?>" required>
                    </div>
                        ...
                        <select class="form-select" id="account_id" name="account_id" required>
                            ...
                            <?php foreach ($accounts as $account): ?>
                                <option value="<?= $account['id'] ?>"
                                    <?= old('account_id', $opportunity['account_id']) == $account['id'] ? 'selected' : '' ?>>
                        ...
                        <select class="form-select" id="principal_id" name="principal_id" required>
                            ...
                            <?php foreach ($principals as $principal): ?>
                                <option value="<?= $principal['id'] ?>"
                                    <?= old('principal_id', $opportunity['principal_id']) == $principal['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pic" name="pic"
                            value="<?= old('pic', $opportunity['pic']) ?>" placeholder="Name - Position">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="solution_architect_id" name="solution_architect_id">
                            ...
                            <?php foreach ($solution_architects as $sa): ?>
                                <option value="<?= $sa['id'] ?>"
                                    <?= old('solution_architect_id', $opportunity['solution_architect_id']) == $sa['id'] ? 'selected' : '' ?>>
                                    <?= esc($sa['sa_name']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        ...
                        <select class="form-select" id="license_type_id" name="license_type_id">
                            ...
                            <?php foreach ($license_types as $license): ?>
                                <option value="<?= $license['id'] ?>"
                                    <?= old('license_type_id', $opportunity['license_type_id']) == $license['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="services_license" name="services_license"
                            rows="3" placeholder="Describe the services and licenses required..."><?= old('services_license', $opportunity['services_license']) ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="estimated_value" name="estimated_value"
                            value="<?= old('estimated_value', $opportunity['estimated_value']) ?>" step="0.01" min="0" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="opportunity_status" name="opportunity_status">
                            <option value="introduction" <?= old('opportunity_status', $opportunity['opportunity_status']) == 'introduction' ? 'selected' : '' ?>>Introduction</option>
                            <option value="qualification" <?= old('opportunity_status', $opportunity['opportunity_status']) == 'qualification' ? 'selected' : '' ?>>Qualification</option>
                            <option value="proposal" <?= old('opportunity_status', $opportunity['opportunity_status']) == 'proposal' ? 'selected' : '' ?>>Proposal</option>
                            <option value="negotiation" <?= old('opportunity_status', $opportunity['opportunity_status']) == 'negotiation' ? 'selected' : '' ?>>Negotiation</option>
                            <option value="closed_won" <?= old('opportunity_status', $opportunity['opportunity_status']) == 'closed_won' ? 'selected' : '' ?>>Closed Won</option>
                            <option value="closed_lost" <?= old('opportunity_status', $opportunity['opportunity_status']) == 'closed_lost' ? 'selected' : '' ?>>Closed Lost</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="range" class="form-range" id="progress_percentage" name="progress_percentage"
                            min="0" max="100" value="<?= old('progress_percentage', $opportunity['progress_percentage']) ?>"
                            oninput="updateProgressValue(this.value)">
                        <div class="d-flex justify-content-between">
                            <small>0%</small>
                            <small id="progressValue"><?= old('progress_percentage', $opportunity['progress_percentage']) ?>%</small>
                            <small>100%</small>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="progress" name="progress"
                            value="<?= old('progress', $opportunity['progress']) ?>" placeholder="e.g., Proposal Sent, Technical Demo Completed...">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="deal_reg" name="deal_reg"
                            value="<?= old('deal_reg', $opportunity['deal_reg']) ?>" placeholder="e.g., DR-2024-001">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="closing_date" name="closing_date"
                            value="<?= old('closing_date', $opportunity['closing_date']) ?>">
                    </div>

                    <div class="mb-3">
                        <label for="remarks" class="form-label">Remarks</label>
                        <textarea class="form-control" id="remarks" name="remarks"
                            rows="3" placeholder="Additional notes or comments..."><?= old('remarks', $opportunity['remarks']) ?></textarea>
                    </div>
                </div>
            </div>
